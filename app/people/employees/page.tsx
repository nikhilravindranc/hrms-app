...
export default function EmployeesPage() {
  ...
  const statCards = [
    { label: 'Total Employees', value: stats.total, icon: UsersIcon, color: '#004D43' },
    { label: 'Active Employees', value: stats.active, icon: CheckCircleIcon, color: '#00755A' },
    { label: 'On Leave', value: stats.onLeave, icon: ClockIcon, color: '#5E93FF' },
    { label: 'New Joiners', value: stats.newJoiners, icon: UserPlusIcon, color: '#7A9A1E' },
  ]
